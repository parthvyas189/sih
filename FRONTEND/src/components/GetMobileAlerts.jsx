...
// The complete JSON data for the country codes
const countryCodes = [
  ...
  { name: "South Georgia and South Sandwich Islands", dial_code: "+500", code: "GS" },
      ...
      <div className="bg-white p-8 shadow-md border border-gray-300 rounded-lg mb-10 max-w-xl mx-auto">
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex space-x-4 mb-6 justify-center">
            ...
            <select
              className="border border-gray-300 rounded-md p-3 w-28"
              value={countryCode}
